package com.example.sitetrackerpro;
...
private TextView displayCurrent;
 ...
 public void buttonAddClicked(View v) {
  ...
  w.setUrl(EditTextUrl.getText().toString());   //inputs into indexes 0,4,8 of websties arrayList
  w.setUser(EditTextUsername.getText().toString()); //inputs into indexes 1,5,9 of websties arrayList
  w.setEmail(EditTextEmail.getText().toString()); //inputs into indexes 2,6,10 of websties arrayList
  w.setPassword(EditTextPassword.getText().toString()); //inputs into indexes 3,7,11 of websties arrayList
...
public void buttonVisit(View v){
 if (!displayUrl.getText().toString().startsWith("https://") && !displayUrl.getText().toString().startsWith("http://")){
     url = "http://" + displayUrl.getText().toString();
 }
